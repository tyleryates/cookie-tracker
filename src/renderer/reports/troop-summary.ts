  ...
  html += `
    <div style="margin: 20px 0; padding: 15px; background: #e3f2fd; border-radius: 8px; border-left: 4px solid #2196F3;">
      ...
      <ul style="margin: 0; padding-left: 20px; font-size: 0.9em;">
        <li><strong>Scout Summary:</strong> Per-scout sales, inventory, credited booth/direct ship allocations, and cash owed</li>
        ...
        <li><strong>Cookie Popularity:</strong> Sales breakdown by cookie type with percentages</li>
      </ul>
    </div>
  `;
